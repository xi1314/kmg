...
public class RpcDemo {
    //类型列表
    private static class PostScoreIntRpcRequest{
            public String LbId;
            public Integer Score;
    }
    public static class PostScoreIntRpcResponse{
            public String Info;
    }
    public static class DemoRequest{
    }
    private static class DemoFunc2RpcRequest{
            public DemoRequest Req1;
            public DemoRequest Req2;
    }
    private static class DemoFunc3RpcRequest{
            public DemoRequest Req1;
            public DemoRequest Req2;
    }
    private static class DemoFunc4RpcRequest{
            public DemoRequest Req1;
            public DemoRequest Req2;
    }
    private static class DemoFunc5RpcRequest{
            public DemoRequest Req1;
            public DemoRequest Req2;
    }
    public static class DemoFunc5RpcResponse{
            public String Info;
    }
    private static class DemoFunc7RpcRequest{
            public DemoRequest Req1;
            public DemoRequest Req2;
    }
    public static class DemoFunc7RpcResponse{
            public String Response;
    }
    private static class DemoFunc8RpcRequest{
            public DemoRequest Req1;
            public DemoRequest Req2;
            public Integer Req3;
    }
    public static class DemoFunc8RpcResponse{
            public String Info;
    }
    private static class DemoTimeRpcRequest{
            public Date T;
    }
    public static class DemoTimeRpcResponse{
            public Date Out;
    }
    private static class DemoTime2RpcRequest{
            public Date T;
    }
    ...
    public static class Client{
        ...
        public String PostScoreInt(String LbId,Integer Score) throws Exception{
            PostScoreIntRpcRequest reqData = new PostScoreIntRpcRequest();
                reqData.LbId = LbId;
                reqData.Score = Score;
                return this.sendRequest("PostScoreInt", reqData, PostScoreIntRpcResponse.class).Info;
        }
        public void DemoFunc2(DemoRequest Req1,DemoRequest Req2) throws Exception{
            DemoFunc2RpcRequest reqData = new DemoFunc2RpcRequest();
                reqData.Req1 = Req1;
                reqData.Req2 = Req2;
                this.sendRequest("DemoFunc2", reqData, void.class);
        }
        public void DemoFunc3(DemoRequest Req1,DemoRequest Req2) throws Exception{
            DemoFunc3RpcRequest reqData = new DemoFunc3RpcRequest();
                reqData.Req1 = Req1;
                reqData.Req2 = Req2;
                this.sendRequest("DemoFunc3", reqData, void.class);
        }
        public void DemoFunc4(DemoRequest Req1,DemoRequest Req2) throws Exception{
            DemoFunc4RpcRequest reqData = new DemoFunc4RpcRequest();
                reqData.Req1 = Req1;
                reqData.Req2 = Req2;
                this.sendRequest("DemoFunc4", reqData, void.class);
        }
        public String DemoFunc5(DemoRequest Req1,DemoRequest Req2) throws Exception{
            DemoFunc5RpcRequest reqData = new DemoFunc5RpcRequest();
                reqData.Req1 = Req1;
                reqData.Req2 = Req2;
                return this.sendRequest("DemoFunc5", reqData, DemoFunc5RpcResponse.class).Info;
        }
        public String DemoFunc7(DemoRequest Req1,DemoRequest Req2) throws Exception{
            DemoFunc7RpcRequest reqData = new DemoFunc7RpcRequest();
                reqData.Req1 = Req1;
                reqData.Req2 = Req2;
                return this.sendRequest("DemoFunc7", reqData, DemoFunc7RpcResponse.class).Response;
        }
        public String DemoFunc8(DemoRequest Req1,DemoRequest Req2,Integer Req3) throws Exception{
            DemoFunc8RpcRequest reqData = new DemoFunc8RpcRequest();
                reqData.Req1 = Req1;
                reqData.Req2 = Req2;
                reqData.Req3 = Req3;
                return this.sendRequest("DemoFunc8", reqData, DemoFunc8RpcResponse.class).Info;
        }
        public Date DemoTime(Date T) throws Exception{
            DemoTimeRpcRequest reqData = new DemoTimeRpcRequest();
                reqData.T = T;
                return this.sendRequest("DemoTime", reqData, DemoTimeRpcResponse.class).Out;
        }
        public Date DemoTime2(Date T) throws Exception{
